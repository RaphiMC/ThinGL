...
public class Renderer3D extends Renderer {
    ...
    public void skyBox(final CubeMapTexture cubeMapTexture) {
        final VertexBufferBuilder vertexBufferBuilder = this.targetMultiDrawBatchDataHolder.getVertexBufferBuilder(this.skyBox.apply(cubeMapTexture.getGlId()));

        // Right face (+X)
        vertexBufferBuilder.writeVector3f(1F, 1F, 1F).endVertex();
        vertexBufferBuilder.writeVector3f(1F, 1F, -1F).endVertex();
        vertexBufferBuilder.writeVector3f(1F, -1F, -1F).endVertex();
        vertexBufferBuilder.writeVector3f(1F, -1F, 1F).endVertex();
