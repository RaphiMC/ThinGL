...
public abstract class ResizingFramebuffer extends Framebuffer {
    ...
    protected ResizingFramebuffer(final BiFunction<Integer, Integer, ImageStorage> colorAttachmentSupplier, final BiFunction<Integer, Integer, ImageStorage> depthStencilAttachmentSupplier) {
