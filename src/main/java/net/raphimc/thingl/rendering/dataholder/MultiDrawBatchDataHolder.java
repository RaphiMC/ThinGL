...
public abstract class MultiDrawBatchDataHolder {
    ...
    public VertexBufferBuilder getVertexBufferBuilder(final DrawBatch drawBatch) {
        return this.getDrawBatchDataHolder(drawBatch).getVertexBufferBuilder();
    }

    public VertexBufferBuilder getInstanceVertexBufferBuilder(final DrawBatch drawBatch) {
        return this.getDrawBatchDataHolder(drawBatch).getInstanceVertexBufferBuilder();
    }

    public IndexBufferBuilder getIndexBufferBuilder(final DrawBatch drawBatch) {
        return this.getDrawBatchDataHolder(drawBatch).getIndexBufferBuilder();
    }

    public ShaderBufferBuilder getUniformBufferBuilder(final DrawBatch drawBatch, final String name, final Function<MemoryBuffer, ? extends ShaderBufferBuilder> uniformBufferBuilderSupplier) {
        return this.getDrawBatchDataHolder(drawBatch).getUniformBufferBuilder(name, uniformBufferBuilderSupplier);
    }

    public ShaderBufferBuilder getShaderStorageBufferBuilder(final DrawBatch drawBatch, final String name, final Function<MemoryBuffer, ? extends ShaderBufferBuilder> shaderStorageBufferBuilderSupplier) {
        return this.getDrawBatchDataHolder(drawBatch).getShaderStorageBufferBuilder(name, shaderStorageBufferBuilderSupplier);
    }
