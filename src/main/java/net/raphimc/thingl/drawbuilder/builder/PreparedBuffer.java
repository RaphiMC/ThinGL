...
public record PreparedBuffer(DrawBatch drawBatch, DrawBatchDataHolder drawBatchDataHolder, ByteBuffer vertexBuffer, ByteBuffer instanceVertexBuffer, IndexByteBuffer indexBuffer, Map<String, ByteBuffer> uniformBuffers, Map<String, ByteBuffer> shaderStorageBuffers, List<DrawCommand> drawCommands) {
