...
public class SimpleOutlineProgram extends MultiPassPostProcessingProgram<SimpleOutlineProgram> {

    private int width = 1;

    public SimpleOutlineProgram() {
        super(BuiltinPrograms.getShader("post/post_processing", Shader.Type.VERTEX), BuiltinPrograms.getShader("post/simple_outline", Shader.Type.FRAGMENT), s -> {
