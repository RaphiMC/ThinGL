...
public class SwingWindowExample extends SwingApplicationRunner {

    public static void main(String[] args) {
        new SwingWindowExample().launch();
    }

    public SwingWindowExample() {
        super(new Configuration().setWindowTitle("ThinGL Swing Example").setExtendedDebugMode(true));
    }
    ...
    protected void launchWindowSystem() {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            swingButton.setFont(swingButton.getFont().deriveFont(20f));
            swingButton.addActionListener(System.out::println);

            this.frame.add(swingButton, BorderLayout.NORTH);
